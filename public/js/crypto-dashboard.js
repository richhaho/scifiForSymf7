  ...
  setTimeout(() => {
    ...
    var chart1 = new ApexCharts(document.querySelector("#crypto-price"), options);
    chart1.render();
    /* Crypto Currency Price Chart */
    ...
    var chart1 = new ApexCharts(document.querySelector("#popTrades"), options);
    chart1.render();
    /* Prediction Meter */
  ...
  document.getElementById('Ethereum-price-graph').innerHTML = '';
  var spark5 = new ApexCharts(document.querySelector("#Ethereum-price-graph"), spark5);
  spark5.render();
...
(function () {
    ...
    const values = [{
    value: '1',
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="../assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg" /> Bitcoin',
    id: 1
  }, {
    value: '2', 
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="../assets/images/crypto-currencies/crypto-icons/cardano-ada-logo.svg" /> Cardano',
    id: 2
  }, {
    value: '3',
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="../assets/images/crypto-currencies/crypto-icons/dogecoin-doge-logo.svg" /> DodgeCoin',
    id: 3
  }, {
    value: '4',
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="../assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg" /> Ethereum',
    id: 4
  }, {
    value: '5',
    label: '<img class="avatar avatar-xs avatar-rounded me-1" src="../assets/images/crypto-currencies/crypto-icons/tether-usdt-logo.svg" /> Tether',
    id: 5
  }]
  const element = document.querySelector('#choices-images');
